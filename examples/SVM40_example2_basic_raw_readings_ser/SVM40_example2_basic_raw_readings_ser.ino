 ...
 *  
 *  Example shows how to read basic values from the SVM40 using Serial communication.
...
void setup() {
 ...
 Serial.begin(115200);
  ...
  serialTrigger((char *) "SVM40-Example2: Basic + raw reading serial. press <enter> to start");
...
bool read_all()
{
  ...
  if (ret == ERR_OK)  {
    ...
    Serial.print(F("\n"));
    Serial.println(F("could not get system time.\n"));
  }
